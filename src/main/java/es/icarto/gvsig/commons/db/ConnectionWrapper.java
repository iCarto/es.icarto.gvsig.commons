...
public class ConnectionWrapper {
	 ...
	 * resultset in the table. If the query doesn't get any result the table will be
	 * empty
	 *
	...
	/**
	 * Appends to the given table as match columns and rows as the columns and rows
	 * that has the resulset of the executed query
	 *
	 * @param query to be executed
	 * @param table to append the data
	 */
	...
	private void toTable(ResultSet rs, DefaultTableModel table) throws SQLException {
