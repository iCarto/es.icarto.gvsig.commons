...
public class SingleDBConnectionManager {
	...
	private JDBCServerExplorerParameters createServerExplorerParams(
		...
		// TODO. El pool persiste el nombre de conexión empleado. Por tanto sin
		// con dbconnection
		// nos estamos conectando a una base de datos distinta, al pasar por
		// aquí recuperará datos
		// erróneos
